...
class CqSdk:
    ...
    msg 消息内容
    """
    def sendPrivateMsg(self, AuthCode:int, QQID:int, msg:str) -> int:
    ...
    """
    def CQ_setGroupKick(self, AuthCode:int, groupid:int, QQID:int, rejectaddrequest:bool) -> int:
    ...
    """
    def setGroupBan(self, AuthCode:int, groupid:int, QQID:int, duration:int) -> int:
    ...
    """
    def CQ_setGroupAdmin(self, AuthCode:int, groupid:int, QQID:int, setadmin:bool) ->int:
        return self.CQDLL.CQ_setGroupBan(c_int(AuthCode), c_int(groupid), c_int(QQID), c_bool(rejectaddrequest)) 
    ...
    """
    def setGroupWholeBan(self, AuthCode:int, groupid:int, enableban:bool) ->int:
    ...
    """
    def setGroupAnonymousBan(self, AuthCode:int, groupid:int, anomymous:str, duration:int) ->int:
    ...
    """
    def setGroupAnonymous(self, AuthCode:int, groupid:int, enableanomymous:bool) ->int:
    ...
    newcard 新名片(昵称)
    """
    def setGroupCard(self, AuthCode:int, groupid:int, QQID:int, newcard:str) ->int:
    ...
    """
    def setGroupLeave(self, AuthCode:int, groupid:int, isdismiss:bool) ->int:
    ...
    """
    def setGroupSpecialTitle(self, AuthCode:int, groupid:int, QQID:int, newspecialtitle:str, duration:int) ->int:
    ...
    discussid 目标讨论组号
    """
    def setDiscussLeave(self, AuthCode:int, discussid:int) ->int:
    ...
    remark 添加后的好友备注
    """
    def setFriendAddRequest(self, AuthCode:int, responseflag:str, responseoperation:int, remark:str) ->int:
    ...
    """
    def setGroupAddRequestV2(self, AuthCode:int, responseflag:str, requesttype:int, responseoperation:int, reason:str) ->int:
    ...
    nocache 不使用缓存
    """
    def getGroupMemberInfoV2(self, AuthCode:int, groupid:int, QQID:int, nocache:bool) ->str:
    ...
    nocache 不使用缓存
    """
    def getStrangerInfo(self, AuthCode:int, QQID:int, nocache:bool) -> str:
    ...
    content 内容
    """
    def addLog(self, AuthCode:int, priority:int, category:str, content:str) ->int:
